...
import AeroFactsPanel from '@/features/academy/components/AeroFactsPanel';
import { Box, Circle, Upload, Mountain, Globe, Wind, Layers, Settings, X, BookOpen, Info } from 'lucide-react';
import Export3DModal from '../components/export/Export3DModal';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 min-h-[500px]">
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar flex flex-col pt-2 pb-2">
            <ControlSlider label="Wind Speed"    value={windSpeed}     min={0}   max={300}   step={5}  unit={units === 'imperial' ? 'mph' : 'm/s'} onChange={setWindSpeed}     accent="neon"/>
